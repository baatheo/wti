...
X_train.to_csv("/home/vagrant/PycharmProjects/wtiproj03/X_train.csv", index=False)
y_train.to_csv("/home/vagrant/PycharmProjects/wtiproj03/y_train.csv", index=False)
