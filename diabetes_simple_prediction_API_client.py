...
def get_test_samples_features_df():
    test_df = pd.read_csv("/home/vagrant/PycharmProjects/wtiproj03/X_test.csv")
    return test_df


def get_test_samples_labels_df():
    test_true_labels_df = pd.read_csv("/home/vagrant/PycharmProjects/wtiproj03/y_test.csv", header=None)
...
diabetes = pd.read_csv("/home/vagrant/PycharmProjects/wtiproj03/diabetes.csv")
